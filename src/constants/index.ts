...
export const ITEM_BASE_CLASS = clsx(
  "bg-500 backdrop-blur-md",
);

export const ITEM_CLASS = clsx(
  "border-white border-2 border-opacity-40 rounded-md",
  ITEM_BASE_CLASS,
  "py-2 px-3",
);

export const INPUT_CLASS = clsx("h-6 bg-white rounded-md bg-opacity-10");
...
export const GRADIENT =
  "bg-gradient-to-r from-blue to-purple";5